...
// in simulator we redefine to format for GitTest2 Developer console
...
{\
	NSString * exceptionName = [@"org.gittest2." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gittest2";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIGitTest2NativeItemNone = -1, 
	UIGitTest2NativeItemSpinner = -2,
	UIGitTest2NativeItemProgressBar = -3,
	
	UIGitTest2NativeItemSlider = -4,
	UIGitTest2NativeItemSwitch = -5,
	UIGitTest2NativeItemMultiButton = -6,
	UIGitTest2NativeItemSegmented = -7,
	
	UIGitTest2NativeItemTextView = -8,
	UIGitTest2NativeItemTextField = -9,
	UIGitTest2NativeItemSearchBar = -10,
	
	UIGitTest2NativeItemPicker = -11,
	UIGitTest2NativeItemDatePicker = -12,
	
	UIGitTest2NativeItemInfoLight = -13,
	UIGitTest2NativeItemInfoDark = -14,
	
	UIGitTest2NativeItemDisclosure = -15,
	
	UIGitTest2NativeItemContactAdd = -16
};
