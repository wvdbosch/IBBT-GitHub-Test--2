...
//@interface GitTest2Object : NSObject
//@end

@interface GitTest2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GitTest2Object class]])
		{
			for (NSString *key in [[(GitTest2Object*)o modules] allKeys])
			{
